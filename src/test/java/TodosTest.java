...
class TodosTest {
    @Test
    public boolean shouldAddThreeTasksOfDifferentType() {
    ...
    public void notMatchesSimpleTask() {
        SimpleTask task = new SimpleTask(2, "Помочь родителям");
    ...
    public void notMatchesEpic() {
        ...
        boolean expected = false;
        boolean actual = epic.matches("Рис");
        Assertions.assertEquals(expected, actual);
    }
    ...
    @Test
    public void notMatchesMeetingTopic() {
        Meeting meeting = new Meeting(
                555,
                "Выкатка 3й версии приложения",
                "Приложение НетоБанка",
    ...
    @Test
    public void notMatchesMeetingProject() {
        Meeting meeting = new Meeting(
                555,
                "Выкатка 3й версии приложения",
                "Приложение НетоБанка",
        ...
        boolean expected = false;
        boolean actual = meeting.matches("Страница");
        Assertions.assertEquals(expected, actual);
    }

    @Test
    public void notMatchesMeetingStart() {
        Meeting meeting = new Meeting(
                555,
                "Выкатка 3й версии приложения",
                "Приложение НетоБанка",
    ...
    @Test
    public void FoundTasksEverywhere() {
